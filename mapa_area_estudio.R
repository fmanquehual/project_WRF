...
legend(x.e1,y.e1, title=NULL, text.font = 2, c('Glaciers', 'Baker river basin', 'Boundary'), bty='o', lty=c(NA, NA, 1),
...
# union de mapas ----
e1 <- as.grob(~c(#plot(ocean, col='#0b243b', border='#0b243b'), 
  plot(dem, col=col.i, axes=FALSE, breaks=breaks.i, box=0),
